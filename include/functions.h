...
void ActorShape_Init(ActorShape* shape, f32 yOffset, ActorShadowFunc func, f32 scale);
...
void func_800B4F78(TargetContext* targetContext, s32 type, GlobalContext* ctxt);
void func_800B5040(TargetContext* targetContext, Actor* actor, s32 type, GlobalContext* ctxt);
...
f32 func_800C4188(GlobalContext* param_1, CollisionContext* param_2, CollisionPoly** param_3, UNK_PTR param_4, Actor* param_5, Vec3f* param_6);
